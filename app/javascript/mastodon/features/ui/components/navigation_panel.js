...
const NavigationPanel = () => (
  <div className='navigation-panel'>
    ...
    <NavLink className='column-link column-link--transparent' to='/trends'><Icon className='colmun-link__icon' id='fire' fixedWidth /><FormattedMessage id='navigation_bar.trends' defaultMessage='Trending now' /></NavLink>
